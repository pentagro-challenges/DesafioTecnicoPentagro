...
**Este é o único documento de instruções**: não existe outro enunciado. O documento de **apoio** é a
especificação, o contrato do sistema. Leia até o fim antes de começar: são cerca de 25 minutos de
leitura atenta, e eles evitam retrabalho depois.
...
| **Uso de IA** | Liberado e esperado. Veja a [seção 5](#5-uso-de-inteligência-artificial). |
